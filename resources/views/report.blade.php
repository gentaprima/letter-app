      ...
      <div class="card p-5 rounded mb-3">
        <div class="d-flex align-items-center">
          <div class="input-group">
            ...
            <button data-toggle="modal" data-target="#modalFilter" onclick="filter()" type="button" class="btn btn-outline-primary size-btn"><i class="fa fa-filter"></i> Filter</button>
            <?php if($filter == true){ ?>
...
<div class="modal fade" id="modalFilter" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
        ...
        <form id="form-modal" method="get" action="">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="date" name="startDate" class="form-control" id="exampleInputbirthDate1" aria-describedby="birthDateHelp" placeholder="Tanggal Lahir">
            </div>
          </div> 
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="date" name="endDate" class="form-control" id="exampleInputbirthDate1" aria-describedby="birthDateHelp" placeholder="Tanggal Lahir">
            </div>
          </div> 
        </div>
