                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-12  pb-4 col-sm-12 col-md-12">
                            ...
                            <div class="input-group">
                              ...
                              <textarea disabled rows="5" type="text" name="perihal" class="form-control" id="exampleInputperihal1" aria-describedby="perihalHelp" placeholder="Perihal Surat">{{$letter->perihal}}</textarea>
                            </div>
                          </div>        
                          <div class="col-lg-12 pb-4 col-sm-12 col-md-12">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="form-modal" method="POST" action="/dashboard/surat-masuk/disposisi/{{Request::segment(4)}}">
                <label for="exampleInputEmail1">Kepada</label>
                <div class="input-group">
                  {{-- <input required type="date" name="tanggal_surat" class="form-control" id="exampleInputtanggal_surat1" aria-describedby="tanggalSuratHelp" placeholder="Tanggal Surat"> --}}
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="form-modal" method="POST" action="/dashboard/arsip">
            <div class="col-lg-12 pb-4 col-sm-12 col-md-12">
                ...
                <div class="input-group">
                  ...
                  <input required type="date" name="tanggal_arsip" class="form-control" id="exampleInputtanggal_surat1" aria-describedby="tanggalSuratHelp" placeholder="Tanggal Arsip">
                </div>
            </div>  
          ...
          <div class="modal-footer">
            <button type="button" id="close" onclick="closeModal('#arsipModal')" class="btn btn-secondary" data-dismiss="modal">Close</button>
